...
console.log(obj)
let addToList =`<li id=${obj.id}>${obj.amount}  ${obj.description}  ${obj.category}
<button onClick=deleteDetails("${obj.id}")>Delete</button>
<button onClick=editDetails("${obj.id}","${obj.amount}","${obj.description}","${obj.category}")>Edit</button>`
